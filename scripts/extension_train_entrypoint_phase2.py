...
def run_training():
    ...
    model_name = f"Modern/base-classiccc-8192-unigram-32768-1epoch-erlsp"
    ...
    training_args = TrainingArguments(
        ...
        #torch_compile_backend="inductor",    # Default high-performance backend
    ...
    lr_scheduler = get_wsd_schedule(
        ...
        num_warmup_steps=0,
        num_stable_steps=int(total_steps * 0.75),
        num_decay_steps=int(total_steps * 0.25),
        min_lr_ratio=1e-6,
        num_cycles=0.5,
    )
