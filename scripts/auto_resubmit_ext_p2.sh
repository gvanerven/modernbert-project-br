...
if [ "$ITERATION" -eq 1 ]; then
    ...
    NEXT_JOB_ID=$(sbatch --parsable --dependency=afternotok:${CURRENT_JOB_ID} $WORK/modernbert-project-br/scripts/auto_resubmit_ext_p2.sh)
...
#
rocm-smi
accelerate launch --multi_gpu --num_processes=8 --num_machines=1 --fsdp_use_orig_params true --dynamo_backend="no" --mixed_precision="bf16" $WORK/modernbert-project-br/scripts/extension_train_entrypoint_phase2.py 
